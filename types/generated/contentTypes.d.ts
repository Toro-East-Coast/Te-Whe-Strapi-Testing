...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activities: Schema.Attribute.Component<'activities.activity-block', true>;
    content_blocks: Schema.Attribute.Component<'content.content-block', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiVocabularyVocabulary extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    audio_pronunciation: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    curricula: Schema.Attribute.Relation<
      'manyToMany',
      'api::curriculum.curriculum'
    >;
    difficulty_level: Schema.Attribute.Enumeration<
      ['beginner ', 'intermediate', 'advanced']
    >;
    english_translation: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    maori_word: Schema.Attribute.String;
